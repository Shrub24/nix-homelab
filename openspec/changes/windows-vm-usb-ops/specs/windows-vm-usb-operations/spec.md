...
- USB devices MUST NOT become part of the persistent VM boot contract.
- IDs MUST be four hexadecimal digits each.
- Commands MUST default to `home-forge` and `windows-dj` while allowing explicit host and VM overrides.

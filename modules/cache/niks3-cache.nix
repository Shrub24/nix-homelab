# Niks3 cache-server deployment aspect: selection supplies the server leaf's
# top-level enablement; the host/API-token and service secret sources stay
# explicit host variants. This aspect is the binary-cache server only; the

...
{
  options = {
    "disko-second-disk" = lib.mkOption {
  ...
  config = {
    ...
    disko.devices.disk.storage = lib.mkIf (config.disko-second-disk != null) {
      type = "disk";
        ...
        partitions = {
          storage = {
            ...
            content = {
              ...
              mountOptions = [ "x-systemd.device-timeout=10s" ];
            };
          };
        };
      };

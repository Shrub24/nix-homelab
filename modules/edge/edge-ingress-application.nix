# Edge ingress application contributor of the `edge` aspect: declares
# `applications."edge-ingress"` and its runtime. It contributes to the same
# `flake.modules.nixos.edge` publication as ../edge.nix (which projects routes
# into it) and ../edge-ingress-runtime.nix (the proxy service runtime).
{

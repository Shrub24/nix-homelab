...
- `modules/applications/<name>/default.nix` for feature composition roots (multi-service stacks), e.g. `modules/applications/admin/`; the music stack converted in Stage 6 (D-052) into the discovered aspect `modules/flake/music.nix`
